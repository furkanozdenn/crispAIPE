...
if __name__ == '__main__':
    ...
    log_dir = config_training['log_dir']
    if not os.path.isabs(log_dir):
        log_dir = os.path.normpath(os.path.join(os.path.dirname(os.path.abspath(args.config)), log_dir))
    save_dir = os.path.join(log_dir, config_file_name, date_suffix)
    ...
    logger.log_hyperparams({**config_model, **config_data, **config_training, "model_type": args.model_type})
